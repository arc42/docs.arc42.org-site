...
![Three components side by side, with logging and security drawn as arrows running straight through all of them]({{ site.imageurl }}/08/crosscutting-concerns-EN.svg)
